...
import com.spoiligaming.explorer.minecraft.common.requireExistingFile
import com.spoiligaming.explorer.util.OSUtils
import java.nio.file.Files
import java.nio.file.Path
import java.nio.file.Paths

object ServerListPaths : PathResolver {
    ...
    override fun findDefault(): Path? {
        ...
        val p =
            when {
                ...
                OSUtils.isLinux -> Paths.get(home, ".minecraft", "servers.dat")
                else -> return null
            }
        return p.takeIf(Files::exists)
    }

    override fun validate(path: Path?) = requireExistingFile(path)
}
